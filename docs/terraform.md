...
| <a name="input_destination_vault_arns"></a> [destination\_vault\_arns](#input\_destination\_vault\_arns) | List of Amazon Resource Names (ARNs) that uniquely identifies the destination backup vaults for the copied backup | `list` | `null` | no |
